...
import 'package:yt_lite_app/presentation/core/widget/full_screen_loading_overlay.dart';
        ...
        return FullScreenLoadingOverlay(
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Text(
                widget.title,
                style: TextStyle(color: AppColors.textPrimary, fontSize: 16, fontWeight: .w600),
              ),
            ),
